...
export const PORTFOLIO_DATA = {
  ...
  about: {
    dialogue: "HALO! SAYA SEORANG DATA ANALYST & LULUSAN S1 SISTEM INFORMASI DENGAN PASSION DALAM MENGOLAH DATA OPERASIONAL, MEMBANGUN MODEL PREDIKTIF, SERTA MERANCANG DASHBOARD INTERAKTIF UNTUK MEMBANTU PERUSAHAAN MENGAMBIL KEPUTUSAN BISNIS YANG STRATEGIS DAN TERUKUR!",
    dialogue_en: "HELLO! I AM A DATA ANALYST & INFORMATION SYSTEMS GRADUATE DRIVEN BY UNCOVERING DATA PATTERNS, BUILDING PREDICTIVE MODELS, AND CREATING INTERACTIVE DASHBOARDS TO EMPOWER STRATEGIC, DATA-BACKED BUSINESS DECISIONS!",
