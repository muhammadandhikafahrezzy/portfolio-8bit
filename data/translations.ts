    ...
    portals: {
      ...
      stages: {
        about: {
          stage: "STAGE 01",
          title: "PROFIL & STATUS",
          desc: "Profil profesional, ringkasan keahlian analitik, dan latar belakang pendidikan.",
        },
        projects: {
          stage: "STAGE 02",
          title: "GALERI PROYEK",
          desc: "Kumpulan proyek data analytics, machine learning, visualisasi dashboard, dan solusi sistem berbasis data.",
        },
        experience: {
          stage: "STAGE 03",
          title: "TIMELINE KARIR",
          desc: "Riwayat perjalanan karir, pengalaman kerja profesional, magang, dan proyek industri.",
        },
        certificates: {
          stage: "STAGE 04",
          title: "RUANG TROFI",
          desc: "Koleksi sertifikasi resmi, pelatihan kompetensi industri, dan pencapaian akademik.",
        },
        minigame: {
          stage: "BONUS STAGE",
          title: "DATA KNIGHT VS ULER 🗡️🐍",
          desc: "Mini game interaktif 8-bit bertema ksatria data mengumpulkan bit informasi dan menaklukkan rintangan.",
        },
        contact: {
          stage: "STAGE 05",
          title: "KOTAK SURAT",
          desc: "Saluran komunikasi langsung untuk diskusi peluang karir, tawaran proyek, dan jaringan profesional.",
        },
      },
    },
    about: {
    ...
    portals: {
      ...
      stages: {
        about: {
          ...
          desc: "Professional profile, analytical skill breakdown, and academic foundation.",
        },
        projects: {
          stage: "STAGE 02",
          title: "PROJECT VAULT",
          desc: "Showcase of data analytics, machine learning, dashboard visualization, and data-driven solutions.",
        },
        experience: {
          stage: "STAGE 03",
          title: "CAREER TIMELINE",
          desc: "Career journey, professional work experience, internships, and industry milestones.",
        },
        certificates: {
          stage: "STAGE 04",
          title: "TROPHY ROOM",
          desc: "Collection of verified professional certifications, training credentials, and academic honors.",
        },
        minigame: {
          stage: "BONUS STAGE",
          title: "DATA KNIGHT VS ULER 🗡️🐍",
          desc: "An interactive 8-bit retro mini game exploring data bit collection and overcoming bugs.",
        },
        contact: {
          stage: "STAGE 05",
          title: "MAILBOX HUB",
          desc: "Direct communication channels for job opportunities, project collaborations, and networking.",
        },
      },
    },
    about: {
