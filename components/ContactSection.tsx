        ...
        <div className="p-3 md:p-4 bg-[#0a1622] flex-1 flex flex-col justify-between space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 font-pixel text-[8px]">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => soundManager.playClick()}
              className="flex items-center gap-2 bg-[#334155] hover:bg-[#475569] text-white p-2 border-2 border-black shadow-[2px_2px_0px_#000] active:translate-y-0.5 transition-transform"
            >
              <svg className="w-3.5 h-3.5 flex-shrink-0 fill-current" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center justify-between gap-2 bg-[#1e293b] hover:bg-[#334155] text-yellow-300 p-2 border-2 border-black shadow-[2px_2px_0px_#000] active:translate-y-0.5 transition-transform cursor-pointer text-left sm:col-span-3"
            >
